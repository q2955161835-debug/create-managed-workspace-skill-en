...
It does not generate domain-specific business logic. Instead, it builds the operating structure around the work: rules, project maps, task indexes, progress logs, temporary test areas, final output folders, a place for reusable skills, and a dedicated `try/` folder for each small project.
...
- Loss of reusable local skills due to lack of storage conventions.
...
- skills/ stores reusable workspace skills (initially empty).
